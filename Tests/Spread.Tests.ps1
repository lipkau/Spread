...
$moduleRoot        = "$projectRoot\Spread"

$manifestFile      = "$moduleRoot\Spread.psd1"
...
Describe 'Module Integrity Tests' {
    ...
    Context "Manifest, changelog, and AppVeyor" {
        ...
        # tests goes to Dave Wyatt, the genius behind Pester.  I've just adapted them slightly
        ...
        It "Manifest file includes the correct root module" {
            $script:manifest.RootModule | Should Be 'Spread.psm1'
        }

        It "Manifest file includes the correct guid" {
            $script:manifest.Guid | Should Be 'b81cfbcc-8b51-408f-805a-130d00f34c65'
        }
