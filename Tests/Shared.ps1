...
function defParam([System.Management.Automation.FunctionInfo]$Command, [string]$ParameterName)
{
    It "Has a -$ParameterName parameter" {
        $Command.Parameters.Item($ParameterName) | Should Not BeNullOrEmpty
    }
}
